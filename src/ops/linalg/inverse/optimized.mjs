...
export default function (args) {
    const size = Math.round(Math.sqrt(args.of.header.size)),
        template = [...new Array(args.of.header.size).keys()]

    return new Function('args', [
        ...new Array(args.of.header.size).fill(null).map(function (_, i) {
